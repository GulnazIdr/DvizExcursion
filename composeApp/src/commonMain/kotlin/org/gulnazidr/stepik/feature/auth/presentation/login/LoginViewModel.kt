package org.gulnazidr.stepik.feature.auth.presentation.login
...
import org.gulnazidr.stepik.feature.auth.presentation.models.LoginUiState
        ...
        viewModelScope.launch {
            if (loginState.password.isNotEmpty() && loginState.userName.isNotEmpty()) {
                when (val res = loginUseCase(loginState.userName, loginState.password)) {
                    ...
                    is AuthResult.Success<Result<Boolean>, AuthError> -> {
                        _authUiEvent.emit(AuthUiEvent.AuthSuccessEvent)
                    }

                    is AuthResult.Error<Result<Boolean>, AuthError> -> {
