...
import org.gulnazidr.stepik.feature.course_catalog.presentation.components.MainTopAppBar
...
fun CourseCatalogScreen(
    ...
    val isLoggingOut = courseViewModel.logoutEvent

    LaunchedEffect( isLoggingOut) {
        isLoggingOut.collect { event ->
            if (event){
                logout()
            }
        }
            ...
            courseFetchState.courseFetchedResult.Display(
                onSuccess = { courseList ->
                    ...
                    CourseList(
                        ...
                        loadMore = { courseViewModel.fetchCourses(true) },
